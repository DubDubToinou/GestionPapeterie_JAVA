...
public class AppliTestDAL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//SELECT BY MARQUE
			System.out.println("Article By Marque");
			List<Article> articlesByMarque = articleDAO.selectByMarque("Clairef");
			afficherArticles(articlesByMarque);
			System.out.println("---------------------------------------------------------------");

			//SELECT BY MOT CLE
			System.out.println("Article By Mot Cle");
			List<Article> articlesByMotCle = articleDAO.selectByMotCle("plume");
			afficherArticles(articlesByMotCle);
