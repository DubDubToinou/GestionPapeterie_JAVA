...
public class ArticleDAOJdbcImpl implements DAO<Article> {
    ...
    public List<Article> selectByMarque(String marque){
        ...
        List<Article> listeArticlebyMarque = new ArrayList<Article>();
        ...
        try {
            ...
            stmt = con.prepareStatement(
                    "SELECT idArticle,reference,marque,designation,prixUnitaire,qteStock,grammage,couleur,type FROM Articles WHERE marque = ?");
            ...
            while(rs.next()){
                if (TYPE_STYLO.equals(rs.getString("type").trim())){
        ...
        return listeArticlebyMarque;

    }

    public List<Article> selectByMotCle(String motCle){
        List<Article> listeArticleByMotCle =  new  ArrayList<Article>();
        PreparedStatement stmt;
        ...
        try {
            ...
            Connection con = JdbcTools.getConnection();
            stmt = con.prepareStatement(
                    "SELECT idArticle,reference,marque,designation,prixUnitaire,qteStock,grammage,couleur,type FROM Articles WHERE marque like ? or reference like ? or designation like ? ");
            ...
            while (rs.next()) {
                ...
                listeArticleByMotCle.add(article);
            }   
